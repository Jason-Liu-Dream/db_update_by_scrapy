...
class url_object():
    ...
    def removeFragment(self):
        ...
        params = (self.scheme, self.netloc, self.path,
                  self.params, unicode(str(self.querystring)),
                  # self.querystring不是string类型，如果直接unicode的话会有问题，比如少了个参数什么的。
                  # modified by chenying.
                  None)
    ...
    def getRootDomain(self):
        ...
        # def to check URL weather the ip address
